...
<head>
	...
	<style type = "text/css">	
		...
		#signForm{cursor: pointer; color: #fff; border-radius: 5%; margin: 5% auto; margin-left: auto; margin-right: auto; text-align: center; padding: 10px; width: 
			500px; height: 500px; background: rgba(0, 0, 0, 1);}
...
<div id="signForm">
	<h2>Profil Ayarları</h2>
        <p>Güncellemek İçin Tüm Bilgileri Giriniz.</p>
	    <p>Şifrenizi Değiştirmek için <a href="sifre_degistir.php">Tıklayınız</a>.</p>
	    <p>Paylaşımlarınızı Görmek İçin <a href="Posts.php">Tıklayınız</a>.</p>
	    <p><a href="postpage.html">Geri Dön</a></p>
	<form action="Kullanıcı-ayar.php" method="post">
...
<tr>	
	<td> <button type="submit" id="button" class="btn" name='update'>Güncelle</button> </td>
	</tr>	
